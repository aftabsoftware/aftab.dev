          ...
          <div className="container">
            ...
            <div className="pt-10 xl:pt-16 flex gap-10 items-center justify-between">
              ...
              <div className="w-full lg:max-w-2xl flex-1">
                <p>
                 With over 4 years of professional experience, I build scalable, high-performance web applications and eCommerce solutions that help businesses grow. I specialize in custom development, API integrations, performance optimization, and modern frontend technologies while writing clean, maintainable code. Passionate about continuous learning, I focus on creating secure, user-friendly, and future-ready digital experiences that deliver measurable business value.
                </p>
